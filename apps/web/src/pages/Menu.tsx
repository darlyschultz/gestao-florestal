        ...
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h2 className="text-sm font-bold">Menu Principal</h2>
            </div>
          </div>
    ...
    <div className="hidden lg:block mb-8 rounded-2xl bg-gradient-to-r from-forest-800 to-forest-700 text-white p-6 xl:p-8">
      <div className="flex items-center justify-between gap-6">
        <div>
          ...
          <span className="inline-block mt-2 text-xs bg-white/20 px-3 py-1 rounded-full capitalize">
            {user?.perfil}
          </span>
        </div>
...
export function Menu() {
  ...
  return (
    <PageLayout
      ...
      subtitle="Selecione um módulo para continuar"
      header={
        !isDesktop ? (
          <MobileMenuHeader
            user={user}
